//
// Created by himan on 11-07-2025.
//
...
public:
    ...
    COLORS getColor(FACES face, unsigned row, unsigned col) const override {
        int idx = arr[row][col];
        if (idx == 8) return (COLORS)((int) face);
    ...
    uint64_t getCorners() {
        ...
        top_front_right += getColorLetter(getColor(FACES::UP, 2, 2));
        top_front_right += getColorLetter(getColor(FACES::FRONT, 0, 2));
        top_front_right += getColorLetter(getColor(FACES::RIGHT, 0, 0));

        string top_front_left = "";
        top_front_left += getColorLetter(getColor(FACES::UP, 2, 0));
        top_front_left += getColorLetter(getColor(FACES::FRONT, 0, 0));
        top_front_left += getColorLetter(getColor(FACES::LEFT, 0, 2));

        string top_back_left = "";
        top_back_left += getColorLetter(getColor(FACES::UP, 0, 0));
        top_back_left += getColorLetter(getColor(FACES::BACK, 0, 2));
        top_back_left += getColorLetter(getColor(FACES::LEFT, 0, 0));

        string top_back_right = "";
        top_back_right += getColorLetter(getColor(FACES::UP, 0, 2));
        top_back_right += getColorLetter(getColor(FACES::BACK, 0, 0));
        top_back_right += getColorLetter(getColor(FACES::RIGHT, 0, 2));

        string bottom_front_right = "";
        bottom_front_right += getColorLetter(getColor(FACES::DOWN, 0, 2));
        bottom_front_right += getColorLetter(getColor(FACES::FRONT, 2, 2));
        bottom_front_right += getColorLetter(getColor(FACES::RIGHT, 2, 0));

        string bottom_front_left = "";
        bottom_front_left += getColorLetter(getColor(FACES::DOWN, 0, 0));
        bottom_front_left += getColorLetter(getColor(FACES::FRONT, 2, 0));
        bottom_front_left += getColorLetter(getColor(FACES::LEFT, 2, 2));

        string bottom_back_right = "";
        bottom_back_right += getColorLetter(getColor(FACES::DOWN, 2, 2));
        bottom_back_right += getColorLetter(getColor(FACES::BACK, 2, 0));
        bottom_back_right += getColorLetter(getColor(FACES::RIGHT, 2, 2));

        string bottom_back_left = "";
        bottom_back_left += getColorLetter(getColor(FACES::DOWN, 2, 0));
        bottom_back_left += getColorLetter(getColor(FACES::BACK, 2, 2));
        bottom_back_left += getColorLetter(getColor(FACES::LEFT, 2, 0));
